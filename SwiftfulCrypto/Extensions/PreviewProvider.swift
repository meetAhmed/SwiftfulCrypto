...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.56)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.34Tr")
    let stat3 = StatisticModel(title: "Portfolio", value: "$50.4k", percentageChange: -10.45)
